...
const NEETPage = () => {
    ...
    const { data: blogs = [], isLoading: loading, error } = useBlogs('NEET');
    ...
    return (
        ...
        >
            {/* Blurred luxurious background shapes to match DestinationPicker / Engineering */}
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                <h1 className="text-5xl md:text-6xl font-black mb-8 text-center bg-gradient-to-r from-[#FFD700] via-[#FFC872] to-white bg-clip-text text-transparent tracking-tighter">
                    <span className="gold-text">NEET</span> Updates
                </h1>
                <p className="text-center text-[#FFF8E1] mb-12 max-w-2xl mx-auto font-medium">
                    Latest news, tips, and insights for NEET aspirants
                </p>

                {/* Blog Grid */}
                {blogs.length === 0 ? (
                    <div className="text-center py-20">
                        <p className="text-[#FFECB3] text-xl">No NEET updates available yet.</p>
                    </div>
                ) : (
